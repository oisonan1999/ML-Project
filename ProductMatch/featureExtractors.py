...
if __name__ == "__main__":
    met1 = "Apple iPhone 11 Pro Max - 512GB - Midnight Green "
    met2 = "Apple iPhone 11 Pro, 64GB, Midnight Green"
    print('Khoảng cách Levenshtein: {}, MatchScore: {} '.\
          format(levenshtein(met1, met2), levenshtein_rate(met1, met2)))
    print('Khoảng cách Levenshtein(Quy hoạch động): {}, MatchScore: {} '.\
